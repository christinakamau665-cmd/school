...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxComposeLibraryAccessors extends SubDependencyFactory {
        private final AndroidxComposeRemoteLibraryAccessors laccForAndroidxComposeRemoteLibraryAccessors = new AndroidxComposeRemoteLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.compose.remote</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxComposeRemoteLibraryAccessors getRemote() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxComposeRemoteLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxComposeRemoteLibraryAccessors extends SubDependencyFactory {
        private final AndroidxComposeRemoteCreationLibraryAccessors laccForAndroidxComposeRemoteCreationLibraryAccessors = new AndroidxComposeRemoteCreationLibraryAccessors(owner);

        public AndroidxComposeRemoteLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.compose.remote.creation</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxComposeRemoteCreationLibraryAccessors getCreation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxComposeRemoteCreationLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxComposeRemoteCreationLibraryAccessors extends SubDependencyFactory {

        public AndroidxComposeRemoteCreationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compose</b> with <b>androidx.compose.remote:remote-creation-compose</b> coordinates and
         * with version reference <b>remoteCreationCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.compose.remote.creation.compose");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>remoteCreationCompose</b> with value <b>1.0.0-alpha09</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRemoteCreationCompose() { return getVersion("remoteCreationCompose"); }
